...
const Results = () => {
  ...
  const { candidates, electionPhase, registeredStudents, votedUsers, offlineRecords } = useVoting();
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 ml-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {isUnopposed ? (
                              <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-yellow-500/20 text-yellow-600 text-xs font-semibold uppercase tracking-wide">
                                <Trophy className="h-3 w-3" /> Candidate Wins (Unopposed)
                              </span>
                            ) : index === 0 ? (
